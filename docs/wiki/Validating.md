...
1. Perform one of the following steps:
    ...
    - To verify with SAS Studio 5.1:
      ...
      1. In the toolbar, click ![image](uploads/5e48ba91bdbe7ba020770b7afbb33654/image.png) to run the new CAS session code. If any of the verification steps for data access return an error, perform the appropriate configuration steps again.