...
#
# Tip for developers: Use REBUILDS="myservice myotherservice ..." to only rebuild specific ansible-container images.

# Where the zip file is received in your software order email (SOE)
